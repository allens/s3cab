 ...
 * what `setup`/`backup` push to the remote marker and `reconnect` writes back. Verbatim
...
/**
 * Write a set's local `exclude.txt` from text — used by `reconnect` to recreate
 ...
 * `seedStarterExclude` below; reconnect reproduces the remote config exactly and
