...
- [0053](0053-reconnect-command.md) — Split `setup --inherit` into its own `reconnect` command; `setup` is create-only *(resolves 0036's deferred "`--inherit` stays a flag" item)*
