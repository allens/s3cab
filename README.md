...
Finding files in '~\Photos'… 1,204 in 0 sec
...
| `s3cab cleanup <bucket>`      | Reclaim storage held by objects no snapshot references — confirms first (`-n`/`--dry-run` previews; `--force` for scripts). |
